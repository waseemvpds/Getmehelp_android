...
public class Custom_View_Nearby_Fuelprovider extends BaseAdapter {
    String[]freid,name,email,contact_no,latitude,longitude;
    private Context context;
    public Custom_View_Nearby_Fuelprovider(Context applicationContext, String[] freid, String[] name, String[] email, String[] contact_no, String[] latitude, String[] longitude) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_nearby_fuelprovider,null);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(context.getApplicationContext());
                SharedPreferences.Editor ed=sh.edit();
                ed.putString("rt_log",freid[i]);
                ed.commit();
                Intent k=new Intent(context.getApplicationContext(),view_fuel_price.class);
...
//                });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ed.putString("rt_log",freid[i]);
                ed.commit();
                Intent k=new Intent(context.getApplicationContext(),send_rating.class);
                k.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(k);
            }
        });
