...
public class mechanic__rating extends AppCompatActivity {
    RatingBar r;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sh.getString("ip","");
        url=sh.getString("url","")+"/mechaic_rating";
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        Toast.makeText(mechanic__rating.this, "Send Rating Successfull", Toast.LENGTH_SHORT).show();
