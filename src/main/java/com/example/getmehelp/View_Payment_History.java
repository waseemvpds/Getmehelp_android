...
public class View_Payment_History extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url=sh.getString("url","")+"/user_payment_history";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                pamount=new String[js.length()];
                                pstatus=new String[js.length()];

                                for(int i=0;i<js.length();i++)
                                {
                                    JSONObject u=js.getJSONObject(i);
                                    pdate[i]=u.getString("pdate");
                                    type[i]=u.getString("type");
                                    details[i]=u.getString("details");
                                    pamount[i]=u.getString("pamount");
                                    pstatus[i]=u.getString("pstatus");
...
//                                }
                                ...
                                li.setAdapter(new Custom_View_Payment_History(getApplicationContext(),pdate,type,details,pamount,pstatus));
