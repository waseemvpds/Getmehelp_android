...
public class View_Nearby_Mechanic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_nearby_mechanic);
        li = findViewById(R.id.Listview);
        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        url=sh.getString("url","")+"/user_view_nearby_mechanic";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    contact_no[i]=u.getString("contact_no");
...
//                                }
                                ...
                                li.setAdapter(new Custom_View_Nearby_Mechanic(getApplicationContext(),mechid,name,email,contact_no,latitude,longitude));
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("logi", gpstracker.longi);
