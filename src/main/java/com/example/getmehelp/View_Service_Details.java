...
public class View_Service_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url=sh.getString("url","")+"/user_view_services";
...
//                                }
                                ...
                                li.setAdapter(new Custom_View_Service_Details(getApplicationContext(),sid,details,amt));
